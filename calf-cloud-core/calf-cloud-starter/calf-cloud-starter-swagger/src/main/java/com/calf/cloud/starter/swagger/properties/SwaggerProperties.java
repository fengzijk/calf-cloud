 ...
 *   -----------------------------------------------------------------------------------
 *  2021-10-05 13:14:01    fengzijk         1.0         Why & What is modified: 改原因描述>
 *
 *
 */

package com.calf.cloud.starter.swagger.properties;
...
public class SwaggerProperties {
    ...
    public static final String PREFIX = "calf-cloud.swagger";
    /**
     * 全局通用参数
     */
